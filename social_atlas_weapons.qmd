...
**Local spatial autocorrelation measures** can also be conducted across the study area, which provide a Moran's I value for each individual hexagon, and can be useful to i**dentify local clusters and outliers.**
...
Now the railway station points can be **extracted**. Steps such as **clipping** the data to the outline of central Birmingham, and s**electing relevant attributes** of each station, such as the name, needs to be conducted here as well.
